...
#
# pkg:gem/rubocop-packs#lib/rubocop/packs/private/configuration.rb:4
module RuboCop; end

# pkg:gem/rubocop-packs#lib/rubocop/cop/packwerk_lite/private.rb:4
module RuboCop::Cop; end

# pkg:gem/rubocop-packs#lib/rubocop/cop/packs/root_namespace_is_pack_name/desired_zeitwerk_api.rb:5
...
#   end
#
# pkg:gem/rubocop-packs#lib/rubocop/cop/packs/class_methods_as_public_apis.rb:31
class RuboCop::Cop::Packs::ClassMethodsAsPublicApis < ::RuboCop::Cop::Base
  # pkg:gem/rubocop-packs#lib/rubocop/cop/packs/class_methods_as_public_apis.rb:40
  sig { params(node: T.untyped).void }
  def on_def(node); end

  # pkg:gem/rubocop-packs#lib/rubocop/cop/packs/class_methods_as_public_apis.rb:35
  sig { returns(T::Boolean) }
  def support_autocorrect?; end

  private

  # pkg:gem/rubocop-packs#lib/rubocop/cop/packs/class_methods_as_public_apis.rb:70
...
#   end
#
# pkg:gem/rubocop-packs#lib/rubocop/cop/packs/documented_public_apis.rb:33
class RuboCop::Cop::Packs::DocumentedPublicApis < ::RuboCop::Cop::Style::DocumentationMethod
  # pkg:gem/rubocop-packs#lib/rubocop/cop/packs/documented_public_apis.rb:51
  sig { params(node: T.untyped).void }
  def check(node); end

  # pkg:gem/rubocop-packs#lib/rubocop/cop/packs/documented_public_apis.rb:74
  sig { params(node: T.untyped).returns(T::Boolean) }
  def node_is_sorbet_signature?(node); end

  # pkg:gem/rubocop-packs#lib/rubocop/cop/packs/documented_public_apis.rb:46
  sig { returns(T::Boolean) }
  def support_autocorrect?; end
end
...
#
# pkg:gem/rubocop-packs#lib/rubocop/cop/packs/root_namespace_is_pack_name/desired_zeitwerk_api.rb:6
class RuboCop::Cop::Packs::RootNamespaceIsPackName < ::RuboCop::Cop::Base
  include ::RuboCop::Cop::RangeHelp

  # pkg:gem/rubocop-packs#lib/rubocop/cop/packs/root_namespace_is_pack_name.rb:32
  sig { void }
  ...
  #
  # pkg:gem/rubocop-packs#lib/rubocop/cop/packs/root_namespace_is_pack_name.rb:79
  sig { returns(T::Boolean) }
  def support_autocorrect?; end

  private

  # pkg:gem/rubocop-packs#lib/rubocop/cop/packs/root_namespace_is_pack_name.rb:86
...
#
# pkg:gem/rubocop-packs#lib/rubocop/cop/packs/root_namespace_is_pack_name/desired_zeitwerk_api.rb:12
class RuboCop::Cop::Packs::RootNamespaceIsPackName::DesiredZeitwerkApi
  ...
  #
  # pkg:gem/rubocop-packs#lib/rubocop/cop/packs/root_namespace_is_pack_name/desired_zeitwerk_api.rb:32
  sig do
    params(
  ...
  # pkg:gem/rubocop-packs#lib/rubocop/cop/packs/root_namespace_is_pack_name/desired_zeitwerk_api.rb:86
  sig { params(pack: ::Packs::Pack).returns(::String) }
  def get_pack_based_namespace(pack); end

  private

  # pkg:gem/rubocop-packs#lib/rubocop/cop/packs/root_namespace_is_pack_name/desired_zeitwerk_api.rb:98
  ...
  # pkg:gem/rubocop-packs#lib/rubocop/cop/packs/root_namespace_is_pack_name/desired_zeitwerk_api.rb:93
  sig { returns(::Pathname) }
  def root_pathname; end
end

# pkg:gem/rubocop-packs#lib/rubocop/cop/packs/root_namespace_is_pack_name/desired_zeitwerk_api.rb:15
...
#   module Foo; end
#
# pkg:gem/rubocop-packs#lib/rubocop/cop/packs/typed_public_apis.rb:22
class RuboCop::Cop::Packs::TypedPublicApis < ::RuboCop::Cop::Sorbet::StrictSigil
  # pkg:gem/rubocop-packs#lib/rubocop/cop/packs/typed_public_apis.rb:38
  sig { void }
  def on_new_investigation; end
end

# pkg:gem/rubocop-packs#lib/rubocop/cop/packwerk_lite/private.rb:5
...
# that would need to be separated prior to proposing any API changes in zeitwerk.
#
# pkg:gem/rubocop-packs#lib/rubocop/cop/packwerk_lite/constant_resolver.rb:11
class RuboCop::Cop::PackwerkLite::ConstantResolver; end

# pkg:gem/rubocop-packs#lib/rubocop/cop/packwerk_lite/constant_resolver.rb:14
class RuboCop::Cop::PackwerkLite::ConstantResolver::ConstantReference < ::T::Struct
  ...
  # pkg:gem/rubocop-packs#lib/rubocop/cop/packwerk_lite/constant_resolver.rb:29
  sig { returns(T::Boolean) }
  def public_api?; end

  # pkg:gem/rubocop-packs#lib/rubocop/cop/packwerk_lite/constant_resolver.rb:24
  sig { returns(::ParsePackwerk::Package) }
  def referencing_package; end

  class << self
    # pkg:gem/rubocop-packs#lib/rubocop/cop/packwerk_lite/constant_resolver.rb:37
    sig do
      params(
...
#   #   - packs/bar
#
# pkg:gem/rubocop-packs#lib/rubocop/cop/packwerk_lite/dependency_checker.rb:39
class RuboCop::Cop::PackwerkLite::Dependency < ::RuboCop::Cop::Base
  # pkg:gem/rubocop-packs#lib/rubocop/cop/packwerk_lite/dependency_checker.rb:48
  sig { params(node: ::RuboCop::AST::ConstNode).void }
  def on_const(node); end

  # pkg:gem/rubocop-packs#lib/rubocop/cop/packwerk_lite/dependency_checker.rb:43
  sig { returns(T::Boolean) }
  def support_autocorrect?; end
end
...
#   end
#
# pkg:gem/rubocop-packs#lib/rubocop/cop/packwerk_lite/privacy_checker.rb:40
class RuboCop::Cop::PackwerkLite::Privacy < ::RuboCop::Cop::Base
  # pkg:gem/rubocop-packs#lib/rubocop/cop/packwerk_lite/privacy_checker.rb:49
  sig { params(node: ::RuboCop::AST::ConstNode).void }
  def on_const(node); end

  # pkg:gem/rubocop-packs#lib/rubocop/cop/packwerk_lite/privacy_checker.rb:44
  sig { returns(T::Boolean) }
  def support_autocorrect?; end
end

# pkg:gem/rubocop-packs#lib/rubocop/cop/packwerk_lite/private.rb:6
module RuboCop::Cop::PackwerkLite::Private
  class << self
    # pkg:gem/rubocop-packs#lib/rubocop/cop/packwerk_lite/private.rb:10
    sig { params(node: ::RuboCop::AST::ConstNode).returns(T::Boolean) }
    def partial_const_reference?(node); end

    # pkg:gem/rubocop-packs#lib/rubocop/cop/packwerk_lite/private.rb:27
    sig do
      params(
...
# pkg:gem/rubocop-packs#lib/rubocop/packs/private/configuration.rb:5
module RuboCop::Packs
  class << self
    # pkg:gem/rubocop-packs#lib/rubocop/packs.rb:16
    sig { void }
    def bust_cache!; end

    # pkg:gem/rubocop-packs#lib/rubocop/packs.rb:27
    sig { returns(::RuboCop::Packs::Private::Configuration) }
    def config; end

    # pkg:gem/rubocop-packs#lib/rubocop/packs.rb:22
    sig { params(blk: T.proc.params(arg0: ::RuboCop::Packs::Private::Configuration).void).void }
    def configure(&blk); end
  end
end

# pkg:gem/rubocop-packs#lib/rubocop/packs.rb:11
RuboCop::Packs::CONFIG_DEFAULT = T.let(T.unsafe(nil), Pathname)

# Because RuboCop doesn't yet support plugins, we have to monkey patch in a
# bit of our configuration.
#
# pkg:gem/rubocop-packs#lib/rubocop/packs/inject.rb:10
module RuboCop::Packs::Inject
  class << self
    # pkg:gem/rubocop-packs#lib/rubocop/packs/inject.rb:14
    sig { void }
    def defaults!; end
  end
end

# pkg:gem/rubocop-packs#lib/rubocop/packs.rb:10
RuboCop::Packs::PROJECT_ROOT = T.let(T.unsafe(nil), Pathname)

# pkg:gem/rubocop-packs#lib/rubocop/packs/private/configuration.rb:6
module RuboCop::Packs::Private
  class << self
    # pkg:gem/rubocop-packs#lib/rubocop/packs/private.rb:13
    sig { void }
    def bust_cache!; end

    # pkg:gem/rubocop-packs#lib/rubocop/packs/private.rb:18
    sig { void }
    def load_client_configuration; end
  end
end

# pkg:gem/rubocop-packs#lib/rubocop/packs/private/configuration.rb:7
class RuboCop::Packs::Private::Configuration
  # pkg:gem/rubocop-packs#lib/rubocop/packs/private/configuration.rb:14
  sig { void }
  def initialize; end

  # pkg:gem/rubocop-packs#lib/rubocop/packs/private/configuration.rb:19
  sig { void }
  def bust_cache!; end

  # pkg:gem/rubocop-packs#lib/rubocop/packs/private/configuration.rb:11
...
# pkg:gem/rubocop-packs#lib/rubocop/packs/private/offense.rb:6
class RuboCop::Packs::Private::Offense < ::T::Struct
  const :cop_name, ::String
  const :filepath, ::String

  # pkg:gem/rubocop-packs#lib/rubocop/packs/private/offense.rb:13
...
#
# pkg:gem/rubocop-packs#lib/rubocop/packwerk_lite.rb:12
module RuboCop::PackwerkLite; end

# pkg:gem/rubocop-packs#lib/rubocop/packwerk_lite.rb:13
